...
class DrawingClassifier:
    ...
    def init_gui(self):
        ...
        self.root = Tk()
        self.root.title(f"Drawing Classifier v1 - {self.proj_name}")
    ...
    def train_model(self):
        ...
        if img_list and class_list:
            ...
            tkinter.messagebox.showerror("Drawing Classifier", "No training data available.", parent=self.root)
    ...
    def save_model(self):
        ...
        if file_path:
            ...
            tkinter.messagebox.showerror("Drawing Classifier", "No file selected.", parent=self.root)
    ...
    def on_closing(self):
        if tkinter.messagebox.askokcancel("Quit", "Do you want to save your project before exiting?"):
